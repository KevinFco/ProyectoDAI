...
?>
                <div class="hero-btn-container">
                    <div class="btn-container">
                        <button type="button" onclick="login()" class="btn hero-btn" >log in</button>
                        <?php
                             session_start();
                             if(isset($_SESSION["isLoggedIn"])){
                                echo "<a class='btn hero-btn' href='logout.php'>Logout</a>";
                             }else{
                                echo "<button type='button' onclick='signUp()' class='btn hero-btn'>sign up</button>";
                             }
                        ?>
                    </div>
                    <div class="btn-container">
                        <button class="btn hero-btn btn-adjust" href="#">EN</button>
                        <button class="btn hero-btn" href="#">日本語</button>
                    </div>
                </div>
                <nav class="top-nav">
                    <!--mobile nav btn-->
